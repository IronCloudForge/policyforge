# METADATA
# title: DM4300-1 — DM4300-1
# description: >-
#   USDA Departmental Manual DM4300-1.
...
sections := {
        "1": {
            "title": "Content",
            "excerpt": "U.S. DEPARTMENT OF AGRICULTURE \n\nWASHINGTON, D.C. 20250 \n\n \n\n \n\nDEPARTMENTAL MANUAL \n\n \nNumber: \n\n 4300-1 \n\nSUBJECT: \n\nEEO Complaint Processing Procedures \n\n \nDATE: \n\nJuly 20, 2001 \n\nOPI: \n\n Office of Civil Rights \n\n\n\n \n\n \n\nCHAPTER I - INTRODUCTION \n\n \n\n \n\n1 PURPOSE AND SCOPE \n\n\n \n\nAs part of its commitment to provide a work environment free from \nemployment actions and/or employment decisions based on race, color, \nreligion, sex, national origin, age, disabilities, retaliation for prior equal...",
        }
}
...
requirements := [
    {
        ...
        "text": "A individual who files a complaint must fully cooperate in the processing of the complaint, which includes providing specific responses to offers of resolution and providing requested information in a timely manner, if available. In addition, all individuals must provide his/her current addresses and telephone numbers and pertine",
        "keyword": "must",
        "mandatory": true,
    },
    {
    ...
    },
    {
        ...
        "section": "1",
        "section_title": "Content",
        "text": "USDA shall extend the 45-day time limit when: a the complainant shows that: (1) he/she was not notified of the time limit, was otherwise unaware of the applicable time limit, and exercised due diligence in pursuing rights to challenge the action; (2) he/she did not know and reasonably should not",
        "keyword": "shall",
        "mandatory": true,
    },
    {
    ...
    },
    {
        ...
        "section": "1",
        "section_title": "Content",
        "text": "the representative, but the complainant must be given the opportunity to contact the representative and/or make the representative a party to the discussion before it proceeds. Where the representative is an attorney and the Office Of General Counsel (OGC) is representing the agency, the OGC representative will only contact the compla",
        "keyword": "must",
        "mandatory": true,
    },
    {
    ...
    },
    {
        ...
        "section": "1",
        "section_title": "Content",
        "text": "in a pay status, shall be on official time, regardless of the tour of duty, when their presence is authorized or required by the agency or the EEOC during the investigation, informal adjustment, or hearing on the complaint. Whatever time is spent in the (official EEO) meetings or hearings is automatically deemed",
        "keyword": "shall",
        "mandatory": true,
    },
    {
    ...
    },
    {
        ...
        "section": "1",
        "section_title": "Content",
        "text": "this determination, agencies and complainants must use the factors of this resolution strategy and apply them in accordance with the concepts involved. The factors of this resolution strategy are: (1) the underlying interest involved, (2) cost, (3) impact on relationships, and (4) risks. Application concepts are: application of the resolutio",
        "keyword": "must",
        "mandatory": true,
    },
    {
    ...
    },
    {
        ...
        "section": "1",
        "section_title": "Content",
        "text": "The complainant must contact an EEO counselor within 45 days of the occurrence of an alleged discriminatory event or personnel action to initiate the informal EEO complaint process. In the case of a class action, the class agent must initiate the informal EEO complaint process. In the case of a class action, th",
        "keyword": "must",
        "mandatory": true,
    },
    {
    ...
    },
    {
        ...
        "section": "1",
        "section_title": "Content",
        "text": "a Agencies shall offer ADR, with limited exceptions, as an alternative to traditional counseling in the informal EEO complaint process. There are cases where ADR need not be offered, but decisions not to offer ADR must be fair, equitable, and consistent with Departmental ADR policy. When ADR is offered, the",
        "keyword": "shall",
        "mandatory": true,
    },
    {
    ...
    },
    {
        ...
        "section": "1",
        "section_title": "Content",
        "text": "Civil Rights will notify the Agency and the EEO counselor must complete and furnish to the Office of Civil Rights and the complainant the counseling report (as described in the Counselor Report Review Checklist in the Appendix) within 15 days of the notice to the Agency of the filing of the complaint. Because the narrative report will become a central",
        "keyword": "must",
        "mandatory": true,
    },
    {
    ...
    },
    {
        ...
        "section": "1",
        "section_title": "Content",
        "text": "Employees of USDA are required to cooperate with the EEO counselor assigned to an EEO complaint. This includes answering all questions asked and providing all documents requested. Employees will deal directly with the EEO counselor when requested, whether or not represented. Failure of complainants to cooperate wi",
        "keyword": "required",
        "mandatory": true,
    },
    {
        ...
        "section": "1",
        "section_title": "Content",
        "text": "A formal complaint must be signed by the complainant and filed in writing within 15 days of receipt of the Notice of Final Interview with the EEO counselor. A complaint is deemed filed on the date postmarked, if addressed to the official designated to receive complaints; or, if not postmarked, on the date received",
        "keyword": "must",
        "mandatory": true,
    },
    {
        ...
        "section": "1",
        "section_title": "Content",
        "text": "All formal complaints must be submitted to the Director of the Office of Civil Rights. No other office is authorized to receive formal complaints, and filing with any other office does not toll the necessary time frames. A complaint is filed on the date complete information, as required by regulations, is actually received by the Office of Civil Rights (CR), and all time frames for processing begin from that date.",
        "keyword": "must",
        "mandatory": true,
    },
    {
        ...
        "section": "1",
        "section_title": "Content",
        "text": "A complaint must include: (1) The complainant’s name, address, and telephone numbers; (2) The name, address, and telephone number of any representative; (3) A specific description, including the dates, of the decision involved in any individual complaint or the policy or practice and incident of applica",
        "keyword": "must",
        "mandatory": true,
    },
    {
    ...
    },
    {
        ...
        "section": "1",
        "section_title": "Content",
        "text": "writing that he/she must seek EEO counseling on the new claim and the applicable time limit. The postmark date of the letter from the complainant would be considered the actual date for the time computation purposes used to determine if the initial EEO counselor contact was timely in accordance with the EEOC regulat",
        "keyword": "must",
        "mandatory": true,
    },
    {
    ...
    },
    {
        ...
        "section": "1",
        "section_title": "Content",
        "text": "In order to accomplish this, the facts must establish a prima facie case of discrimination. This means that their must be material or relevant evidence such that, were it not rebutted, the trier of the fact could conclude that discrimination did occur. Then the record must contain an articulated legitimate, nondiscriminatory explanat",
        "keyword": "must",
        "mandatory": true,
    },
    {
    ...
    },
    {
        ...
        "section": "1",
        "section_title": "Content",
        "text": "Then the record must contain an articulated legitimate, nondiscriminatory explanation for the employment decision. Once the agency has articulated such a reason, the question becomes whether the proffered explanation was the true reason for the agency’s decision, or merely a pretext for discrimination. Disparate",
        "keyword": "must",
        "mandatory": true,
    },
    {
    ...
    },
    {
        ...
        "section": "1",
        "section_title": "Content",
        "text": "'550.805, shall be awarded from the date the individual would have begun duty, assumed the duties of the position at issue, or not been removed from the position unless clear and convincing evidence indicates that the applicant or employee would have not been selected for, placed into, or removed from",
        "keyword": "shall",
        "mandatory": true,
    },
    {
    ...
    },
    {
        ...
        "section": "1",
        "section_title": "Content",
        "text": "amount, the agency will be required to take reasonable corrective actions to prevent recurrence of similar circumstances and the reasons therefor, and submit the information to the Office of Civil Rights. Either the Agency or the Department Office of human Resource Management will review these situations to determine if corrective or disciplinary action is warranted.",
        "keyword": "required",
        "mandatory": true,
    },
    {
    ...
    },
    {
        ...
        "section": "1",
        "section_title": "Content",
        "text": "Agencies shall notify class members within 15 days after acceptance of the complaint acceptance. This notice will contain the name of the agency, its location, and the date of acceptance, fully describe the issues and background of the complaint; explain the binding nature of a final decision or resoluti",
        "keyword": "shall",
        "mandatory": true,
    },
    {
