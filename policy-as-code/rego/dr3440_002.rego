# METADATA
# title: DR3440-002 — Control and Protection of “Sensitive Security Information”
# description: >-
#   USDA Departmental Regulation DR3440-002.
#   Effective: 2003-01-30.
#   Office of Primary Interest: Personnel and, Document Security Division.
# organizations:
...
#   opi: Personnel and, Document Security Division
#   nist_families:
#   - IA
#   - MA
#   - PE
...
#   - SC
#   - SR
#   source_url: https://www.usda.gov/directives/dr-3440-002
#   generated_by: Policy Forge — USDA OCIO DISC
#   generated_at: 2026-08-15T17:16:23Z
package usda.policy.dr3440_002
...
directive := {
    "label":          "DR3440-002",
    "title":          "Control and Protection of “Sensitive Security Information”",
    "directive_type": "Departmental Regulation",
    "effective_date": "2003-01-30",
    "opi":            "Personnel and, Document Security Division",
    "nist_families":  ["IA", "MA", "PE", "PS", "SA", "SC", "SR"],
    "source_url":     "https://www.usda.gov/directives/dr-3440-002",
}
...
sections := {
        "1": {
            "title": "Content",
            "excerpt": "U.S. DEPARTMENT OF AGRICULTURE\n                                     WASHINGTON, D.C. 20250\n\n\n\n\n                                                                                      Number:\n    DEPARTMENTAL REGULATION                                                           3440-2\nSUBJECT: Control and Protection of “Sensitive Security               DATE:\nInformation”                                                         January 30, 2003...",
        }
}
...
requirements := [
    ...
    {
        "id": "dr3440_002-req-003",
        "section": "1",
        "section_title": "Content",
        "text": "determined requires protection against unauthorized disclosure must be marked in a conspicuous manner with the following notice: “Sensitive Security Information - Disseminate on a Need-to-Know Basis Only.” The identification of SSI will be done by: a Marking of the SSI notice at the bottom of the front cover (if one is present), the",
        "keyword": "must",
        "mandatory": true,
    },
    {
        "id": "dr3440_002-req-004",
        "section": "1",
        "section_title": "Content",
        "text": "c Individual portion markings at the beginning of a paragraph containing SSI shall be done using the acronym SSI; d Notating in a cover memo; e Transmittal documents that have no classified information attached but do have SSI attachments shall have the statement “Sensitive Security Information Attachment - Disseminat",
        "keyword": "shall",
        "mandatory": true,
    },
    {
        "id": "dr3440_002-req-005",
        "section": "1",
        "section_title": "Content",
        "text": "SSI attachments shall have the statement “Sensitive Security Information Attachment - Disseminate on Need-to-Know Basis Only” affixed; f Electronically transmitted messages or data containing SSI shall be preceded by the term “Sensitive Security Information - Disseminate on a Need",
        "keyword": "shall",
        "mandatory": true,
    },
    {
        "id": "dr3440_002-req-006",
        "section": "1",
        "section_title": "Content",
        "text": "f Electronically transmitted messages or data containing SSI shall be preceded by the term “Sensitive Security Information - Disseminate on a Need-to-Know Basis Only” at the beginning of the text; g Inclusion in a category identified as SSI use in an organization directive and known to all personnel handling th",
        "keyword": "shall",
        "mandatory": true,
    },
    {
        "id": "dr3440_002-req-007",
        "section": "1",
        "section_title": "Content",
    ...
    {
        "id": "dr3440_002-req-009",
        "section": "1",
        "section_title": "Content",
        "text": "to-know” must not be able to enter areas unescorted or unobserved, and have visual access to SSI.",
        "keyword": "must",
        "mandatory": true,
    },
    {
        "id": "dr3440_002-req-010",
        "section": "1",
        "section_title": "Content",
    ...
    {
        "id": "dr3440_002-req-014",
        "section": "1",
        "section_title": "Content",
        "text": "h SSI that is distributed outside of the Department shall be accompanied by a letter stating that this material is to be treated with the same control measures comparable to the receiving agency’s prescribed measures established comparable to SSI, that at a minimum meet our security control measures (Sensitive",
        "keyword": "shall",
        "mandatory": true,
    },
    {
        "id": "dr3440_002-req-015",
        "section": "1",
        "section_title": "Content",
        "text": "Material of higher sensitivity must be destroyed by shredding. The level of sensitivity of the material will be an integral element in determining the appropriate method of destruction. Small segments of microfiche and microfilm may be readable, therefore, destruction into very small partic",
        "keyword": "must",
        "mandatory": true,
    },
    {
        "id": "dr3440_002-req-016",
        "section": "1",
        "section_title": "Content",
    ...
    {
        "id": "dr3440_002-req-017",
        "section": "1",
        "section_title": "Content",
        "text": "All data storage devices shall be rendered unreadable by approved methods such as degaussing, overwriting (6-7 times with random 1’s and 0’s) or complete physical destruction prior to disposal. OCIO shall provide guidance to all Departmental organizations on current IT security requir",
        "keyword": "shall",
        "mandatory": true,
    },
    {
        "id": "dr3440_002-req-018",
        "section": "1",
        "section_title": "Content",
    ...
    {
        "id": "dr3440_002-req-021",
        "section": "1",
        "section_title": "Content",
        "text": "If SSI must be released to non-government personnel as part of a contract or grant, the head of the USDA organization, in conjunction with DA, shall determine whether the sensitivity of the information justifies a requirement for an investigation of contractor personnel handling the sensitiv",
        "keyword": "must",
        "mandatory": true,
    },
    {
        "id": "dr3440_002-req-022",
        "section": "1",
        "section_title": "Content",
